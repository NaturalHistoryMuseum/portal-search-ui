<template>
  ...
  <zoa-empty label="Taxonomy or synonym" grid-class="taxonomy-all">
    <zoa-textbox
      label="Taxonomy or synonym"
      label-position="none"
      placeholder="e.g. urtica dioica or solanaceae"
      v-model="taxonomyAll"
    />
    <zoa-toggle-button
  ...
  <template v-if="expandTaxonomy">
    <zoa-textbox
      label="Kingdom"
      placeholder="e.g. plantae"
      v-model="taxonomyKingdom"
    />
    <zoa-textbox
      label="Phylum"
      placeholder="e.g. magnoliophyta"
      v-model="taxonomyPhylum"
    />
    <zoa-textbox
      label="Class"
      placeholder="e.g. liliopsida"
      v-model="taxonomyClass"
    />
    <zoa-textbox
      label="Order"
      placeholder="e.g. poales"
      v-model="taxonomyOrder"
    />
    <zoa-textbox
      label="Family"
      placeholder="e.g. cyperaceae"
      v-model="taxonomyFamily"
    />
    <zoa-textbox
      label="Genus"
      placeholder="e.g. eleocharis"
      v-model="taxonomyGenus"
    />
    <zoa-textbox
      label="Species"
      placeholder="e.g. palustris"
      v-model="taxonomySpecies"
    />
    <zoa-textbox
      label="Infraspecies"
      placeholder="e.g. waltersii"
